...
--
-- Name: inv_evento_noticias_documentos; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.inv_evento_noticias_documentos OWNER TO postgres;

--
-- Name: inv_evento_noticias_documentos_id_evento_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE inv_evento_noticias_documentos_id_evento_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.inv_evento_noticias_documentos_id_evento_seq OWNER TO postgres;

--
-- Name: inv_evento_noticias_documentos_id_evento_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE inv_evento_noticias_documentos_id_evento_seq OWNED BY inv_evento_noticias_documentos.id_evento;
...
ALTER TABLE ONLY inv_evento_noticias_documentos ALTER COLUMN id_evento SET DEFAULT nextval('inv_evento_noticias_documentos_id_evento_seq'::regclass);
...
2	63345889	1	pregrado1	2	2014	pregrado2	1	2014	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2 	\N	www.google.com.com	jdjdjjsan dskjdsjkdsjksdkjds fjfjjfjfjf sjsjjsjsjs fjfjfjskjkdskjds fjfjskkjdsjkds fjfjkfjkjfkkjf
3	1	3	pregrado1	3	2013	pregrado2	1	2013	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
691	abierta	Convocatoria para proyectos de investigación o desarrollo tecnológico que aspiran a obtener deducciones tributarias por inversiones o donaciones a partir del año 2015	2015-04-06	2015-05-09	1200000	Registrar y calificar los proyectos de investigación o desarrollo tecnológico, cuya inversión o donación será realizada durante el año 2015, y asignar los respectivos cupos de deducibilidad, para que los contribuyentes del impuesto de renta que hagan dichas inversiones o donaciones, puedan acceder a la deducción en renta del 175% sin superar el 40% de la renta líquida gravable, acorde con lo estipulado en el artículo 158-1 del Estatuto Tributario.\r\n\r\nCRONOGRAMA VENTANILLA ABIERTA\r\n\r\nEn el evento de existir al fin de la convocatoria disponibilidad del cupo máximo definido por el CNBT para el año 2015, la parte aún no asignada se distribuirá por ventanilla abierta en atención al orden de registro de las solicitudes, hasta agotar el cupo disponible o hasta el cierre de la misma, el cual tendrá lugar el último día hábil del mes de agosto, lo que suceda primero.\r\n\r\nApertura de la ventanilla 7 de Abril de 2015\r\nPrimer corte con solicitudes recibidas en ventanilla Mayo 15 de 2015\r\nSegundo corte con solicitudes recibidas en ventanilla Julio 15 de 2015\r\nCierre de la ventanilla: cuando se agote el cupo disponible desde la apertura de la ventanilla. En caso contrario, el 31 de agosto de 2015 a las 5:00pm\r\nCertificación del cupo asignado a proyectos calificados 31 de diciembre 2015\r\n\r\nNota: Cuando el cupo se asigne en el marco de la ventanilla abierta, el beneficio tributario aplicará para las inversiones o donaciones que se realicen a partir del 1 de enero y hasta el 31 de diciembre del año 2015 y según las condiciones definidas y resultantes de la respectiva convocatoria anual.\r\nwww.google.com	a@dkdk.com	6678976	www.google.com	f3.jpg	199-f3.jpg	msmms	1
1	abierta	convocatoria de prueba	2015-04-24	2015-04-24	120000	axnxzmmn scnscmnmxmnz	a@dkdk.com					estudiantes	1
\.


--
-- Data for Name: inv_evento_noticias_documentos; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY inv_evento_noticias_documentos (id_evento, titulo_evento, tipo, descripcion, enlace_documento, fecha, fecha_fin) FROM stdin;
1	evento 1	Evento	esta es la descripcion	evento 1-_MG_2798.jpg	2015-03-29	2015-04-27
2	noticia de prueba	Evento	ddjkdsajkdanm dklsdklklkdllkd		2015-04-24	2015-04-24
\.


--
-- Name: inv_evento_noticias_documentos_id_evento_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('inv_evento_noticias_documentos_id_evento_seq', 2, true);
...
1	2	1	2015-04-27	1234000	esta es la descripcion del financiamiento del proyecto	efectivo
\.
...
SELECT pg_catalog.setval('inv_financiacion_id_financiacion_seq', 1, true);
...
2	1	aa	1	1	A1	sdjsdjdsjkdsn sdjksjjdskjkjksd	2015-04-24	jj@h.com			www.pagina1.com.com						1
1	2	GITECX - GRUPO DE INVESTIGACIÓN EN TECNOLOGÍAS ABIERTAS	1	1	reconocido	estos son los objetivos del grupo	2013-11-24	jj@h.com	6678976	Calle 17 #20-34 barrio las bolitas	gitecx.unillanos.edu.co	b.jpg	www.google.com	e4.jpg	e3.jpg	11166030_10205027676230080_622130662_n.jpg	1
\.
...
SELECT pg_catalog.setval('inv_grupos_codigo_grupo_seq', 2, true);
...
1	663	1	3	ingeniero 	123	convocatorias	123456789	2015-04-20	2015-05-01	www.google.com
2	123456789	1	2	ingeniero 	1234	convocatorias	bbb	2015-04-21	2015-04-09	www.google.com
\.
...
SELECT pg_catalog.setval('inv_investigadores_externos_codinv_ext_seq', 2, true);
...
SELECT pg_catalog.setval('inv_linea_grupos_id_linea_grupos_seq', 1, false);
...
1	1	Teleinformatica		63345889	este es el objeto de estudio de la linea	este es el objetivo de la linea	d4.jpg	d3.jpg	1
\.
...
SELECT pg_catalog.setval('inv_lineas_id_lineas_seq', 1, true);
...
SELECT pg_catalog.setval('inv_participacion_productos_id_participacion_productos_seq', 3, true);
...
1	investigador principal	1	63345889	12 horas
2	coinvestigador	1	1121889	12 horas
\.
...
SELECT pg_catalog.setval('inv_participacion_proyectos_id_participacion_proyectos_seq', 2, true);
...
1	2015	1	2015-04-06	2015-05-09
2	2015	1	2015-04-06	2015-05-09
\.
...
SELECT pg_catalog.setval('inv_periodos_academicos_codigo_periodo_seq', 2, true);
...
COPY inv_productos (codigo_producto, inv_codigo_grupo, inv_id_linea, inv_subtipo_producto, inv_nit, nombre_producto, observaciones_producto, fecha_producto, reconocimiento_producto, observaciones_soporte, soporte_producto, tipo_soporte, foto_producto, autor_producto, estado_activacion, visto) FROM stdin;
2	2	1	1	1	producto de prueba docente 1	kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj	2015-04-22	kjjksjkjkjk	kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj				1	0	1
1	2	1	1	1	producto de prueba docente	kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj	2015-04-22	kjjksjkjkjk	kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj kjfjkjkfjkfds sdfjksfdjjsfsfdjk jdskjsfjksfkjksf fsjsfjksfjsfj	Hoja de contacto-001.jpg		installer_prefs.json	1	0	1
3	2	1	1	1	acdsdskj	jkdsjkdsjkdsjkdskjs	2015-04-21						1	0	0
\.
...
SELECT pg_catalog.setval('inv_productos_codigo_producto_seq', 3, true);
...
1	691	1	1	Proyecto1	este es el objetivo general	e3.jpg			2015-03-29	2016-01-01	1	aprobado
2	691	1	1	Proyecto2	este es el objetivo general				2015-03-29	2016-01-01	1	aprobado
3	691	1	1	aaa	este es el objetivo general				2015-03-29	2016-01-01	1	aprobado
\.
...
SELECT pg_catalog.setval('inv_proyectos_codigo_proyecto_seq', 3, true);
...
1	_MG_2937.jpg	esta es la descripcion	1
2	_MG_2798.jpg	lskaklla LDJDSJKADSKJSA KJADJKDAJSADJKAS DAJKKAJJAJKASJ DASKJSADJKJKADSJ	1
3	d4.jpg	lskaklla LDJDSJKADSKJSA KJADJKDAJSADJKAS DAJKKAJJAJKASJ DASKJSADJKJKADSJ	1
4	f5.jpg	SAJKDSJAJKDAJKDAJKAD JDJKDJKDJKAKKJA	1
5	f17.jpg		1
7	d.jpg		1
\.
...
SELECT pg_catalog.setval('inv_slider_id_slider_seq', 7, true);
...
1	1	sublinea1*	activo	Esta es la descripcion de la sublinea	1
\.
...
SELECT pg_catalog.setval('inv_sublineas_id_sublinea_seq', 1, true);
...
1	1	subtipo1 de producto	esta es la descripcion	1
\.
...
SELECT pg_catalog.setval('inv_tipo_grupos_id_seq', 6, true);
...
1	tipo 1 de producto	esta es la descripcion	1
2	aa		1
\.
...
SELECT pg_catalog.setval('inv_tipo_productos_id_tipo_producto_seq', 2, true);
...
1	Escuela de Ingenieria	444	esta es la descripcion de la unidad
2	unidad academica de ciencias	663	
\.
...
5	otro                          	dmdmd
1	Docente                       	bla bla
3	Joven Investigador            	kakaka
6	Admin Centro Investigaciones  	kkdkdkddkkdd
\.
...
121	andrea	Calle 17 #20-34 barrio las bolitas                                                                  	6678976   	32045     	camargo        	s	J              	jj@h.com                                          	81dc9bdb52d04dc20036dbd8313ed055	2015-03-03 00:00:00	\N
...
663	andrea	Calle 17 #20-34 barrio las bolitas                                                                  	6678976   	3204530643	camargo        		murillo        	jj@h.com                                          	\N	2015-04-01 00:00:00	d5.jpg
12	pedro	                                                                                                    	6657890   	3056789089	gonzalez       	jose	ramirez        	                                                  	202cb962ac59075b964b07152d234b70	2015-03-12 00:00:00	
123456789	laura	CALLE 17 NO.12 A 27                                                                                 	6678976   	3204530642	hernandez      		salazar        	jj@h.com                                          	\N	2015-04-07 00:00:00	_MG_2798.jpg
2123	joh	J                                                                                                   	J         	3         	q              	s	J              	J@SDA                                             	202cb962ac59075b964b07152d234b70	2015-02-02 00:00:00	
1	felipe	gato@co.co                                                                                          	323       	1234      	corredor       	nombre2	apellido2      	miemal@.com                                       	81dc9bdb52d04dc20036dbd8313ed055	\N	d
\.
...
ALTER TABLE ONLY inv_evento_noticias_documentos
...
ALTER TABLE ONLY inv_productos
    ADD CONSTRAINT inv_cedula_persona_fkey FOREIGN KEY (autor_producto) REFERENCES persona(cedula) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: inv_unidad_academica_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY inv_grupos
    ADD CONSTRAINT inv_unidad_academica_fkey FOREIGN KEY (inv_unidad_academica) REFERENCES inv_unidades_academicas(id_unidad) ON UPDATE CASCADE ON DELETE CASCADE;
