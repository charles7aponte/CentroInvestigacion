...
3	12	3	pregrado1	3	2013	pregrado2	1	2013	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
vldl	abiert	Convocatoria2	2015-06-06	2015-07-06	6780000	cmkkvkxlklvz kvkvkvkvk	e@gkgkkg.com	4456778	www.kkk.com	\N	\N	kfkkdkdkkdkdkdk	1
\.
...
6	1	2	2015-03-31	120000	mdmdmdmdmdmdm kdkdkdkdkd	especie
\.
...
SELECT pg_catalog.setval('inv_financiacion_id_financiacion_seq', 6, true);
...
7	1	xxxx1232	212	1	A1	 ssmsmsms smsmsmms msmsmsmsm	2015-03-16	jj@h.com	6678976	Calle 17 #20-34 barrio las bolitas	www.pagina1.com.com					Hoja de contacto-085 copia.jpg	0
...
8	2	grupo de prueba	2123	4	no reconocido	esta es la descripcion de prueba	2015-03-29	andreak_31@hotmail.com	6678976	Calle 17 #20-34 barrio las bolitas	www.pagina1.com.com	d6.jpg	nxnxnxnx.com	f5.jpg	f1.jpg	b2.jpg	1
...
SELECT pg_catalog.setval('inv_grupos_codigo_grupo_seq', 8, true);
...
4	9	1	1	ingeniero 	1234	jjjj	bbb	2015-03-24	2015-03-28	gggg.com
2	1	1	1	ingeniero	1234	hahhaha	jajajajjaja	2015-04-23	\N	www.google.com
\.
...
SELECT pg_catalog.setval('inv_linea_grupos_id_linea_grupos_seq', 3, true);
...
SELECT pg_catalog.setval('inv_participacion_grupos_id_participacion_grupos_seq', 8, true);
...
SELECT pg_catalog.setval('inv_participacion_productos_id_participacion_productos_seq', 7, true);
...
2	investigador principal	1	63345889	12horas
3	coinvestigador	1	2123	12horas
\.
...
14	1	4	1	1	producto de prueba	esta es la descripcion del producto de prueba 	2015-03-30	ansmsmsmsnans	estas son las observaciones del soporte del producto	91-d5.jpg	soporte de prueba	d5.jpg
\.
...
SELECT pg_catalog.setval('inv_productos_codigo_producto_seq', 14, true);
...
1	fffffqaa	5	5	Como se observa los div o contenedores de los extremos tienen un width fijo de 220px, necesito que el div del centro, tenga un width que ...\r\n	mmmm kkkkkk ñññññ				2015-04-06	2015-04-14	2	rechazado
\.
...
SELECT pg_catalog.setval('inv_proyectos_codigo_proyecto_seq', 1, true);
...
2	554-f6.jpg	fghfhg	1
4	macrypt.JPG	djjjjdjd jdjdjdjd jdjdjdj djjdjdjd jdjdjjdjdjjk djjdakakjkajkad jdjdjdjdj jdjdjdjd djjdjdjd	1
5	nature-photo1.png	mdmmdd dmdmdmd mdmdmd	1
3	a.jpg	mncmcnc cjccjcjjc kkdjkdkdkd 	0
6	gr_1354630391_1719535114.jpg	cskkxzkzkzck cklzckczkkzcl czkckzkcllkzc zclzklzcklzclk	1
7	mistura.jpg	asjjksjksjkx< x<jx<jkx<jkj<xkjk<x xxjxjxjjxx jxjxjxjx xjxjxjxj jzjzjzj	1
8	1.jpg	,,,,,,	1
9	nature-photo2.png		1
10	nature-photo4.png		0
\.
...
SELECT pg_catalog.setval('inv_slider_id_slider_seq', 10, true);
...
4	6	sublines de prueba	activa	Esta es la descripcion de la sublinea de prueba	1
\.
...
SELECT pg_catalog.setval('inv_sublineas_id_sublinea_seq', 4, true);
...
12	1	subtipo de producto de prueba	esta es la descripcion del subtipo de producto	1
13	1	subtipo de producto de prueba 1	esta es la descripcion del subtipo de producto	1
\.
...
SELECT pg_catalog.setval('inv_subtipo_productos_id_subtipo_producto_seq', 13, true);
...
5	unidad academica de prueba	63345889	esta es la descripcion de prueba
\.
...
SELECT pg_catalog.setval('inv_unidades_academicas_id_unidad_seq', 5, true);
...
9	andrea	Calle 17 #20-34 barrio las bolitas                                                                  	6678976   	32045     	camargo        	s	J              	jj@h.com                                          	\N	2015-03-03 00:00:00	\N
\.
