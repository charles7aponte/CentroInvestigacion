                ...
                <fieldset>  
                    ...
                    <li class="@if($errors->has('email')) has-error @endif">
                      <label for="email">Email:</label>
                        <input style="text-transform: lowercase;" type="email" id="email" name="email" value="{{ Input::old('email')!=null? Input::old('email'): (isset($grupos['email'])? $grupos['email']:'')}}" required="required" />
