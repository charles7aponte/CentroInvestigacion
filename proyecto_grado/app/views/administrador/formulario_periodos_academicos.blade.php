...
<div>
    ...
    <div> 
        <form id="form-periodos-academicos"  enctype="multipart/form-data" action="{{URL::to('creacion/formularioperiodosacademicos')}}" method="post">
                    ...
                    <fieldset> 
                        ...
                        <label for="titulo-periodo">Per&iacute;odo:</label>
                            <input type="text" id="titulo-periodo" name="titulo-periodo" value="{{Input::old('titulo-periodo')}}" required="required"/> 
                             @if ($errors->has('titulo-periodo')) <p  style="margin-left: 160px;" class="help-block">{{ $errors->first('titulo-periodo') }}</p> 
                             @endif
                        </li>   


                       <li class="@if($errors->has('ano-periodo')) has-error @endif">
                        <label for="ano-periodo">A&ntilde;o:</label>
                            <input type="text" id="ano-periodo" name="ano-periodo" value="{{Input::old('ano-periodo')}}" required="required"/> 
                             @if ($errors->has('ano-periodo')) <p  style="margin-left: 160px;" class="help-block">{{ $errors->first('ano-periodo') }}</p> 
                             @endif
                        </li>  
                        ...
                        <li class="@if($errors->has('fecha-inicio')) has-error @endif">
                                    ...
                                    <div class='col-sm-5' style="padding:0px;">
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker2'>
                                                <input required="required" type="" style="cursor:pointer"  
                                                readonly id="fecha-inicio" class="date form-control" data-format="dd/MM/yyyy" name="fecha-inicio" value="{{Input::old('fecha-inicio')}}"/> 
                            ...
                            @if ($errors->has('fecha-inicio')) <p  style="margin-left: 160px;" class="help-block">{{ $errors->first('fecha-inicio') }}</p> @endif   
                        </li>
                        ...
                        <li class="@if($errors->has('fecha-fin')) has-error @endif">
                                ...
                                <div class="row">
                                    <div class='col-sm-5' style="padding:0px;">
                                        <div class="form-group">
                                            <div class='input-group date' id='datetimepicker2'>
                                                <input required="required" type="" style="cursor:pointer"
                                                readonly id="fecha-fin" class="date form-control" data-format="dd/MM/yyyy" name="fecha-fin" value="{{Input::old('fecha-fin')}}"  /> 
                                                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                                </span>
                                            </div>
                                        </div>
                            ...
                            @if ($errors->has('fecha-fin')) <p  style="margin-left: 160px;" class="help-block">{{ $errors->first('fecha-fin') }}</p> @endif   
                        </li>
         ...
         <ul> 
            <table id="tabla-periodos-academicos" style="margin-top:40px; margin-left:150px; width:700px; border-right:none;">
                <thead>
                  ...
                  <tr>
                    ...
                    @if(isset($periodos))
                       ...
                       @foreach ($periodos as $periodo) <!--array- que viene del controlador-->
                        ...
                        <td style="width:150px;">{{$periodo['periodo']}}</td>

                        <td style="width:150px;">{{$periodo['ano']}}</td>

                        <td style="width:150px;">{{$periodo['fecha_inicio']}}</td>

                        <td style="width:150px;">{{$periodo['fecha_fin']}}</td>      
