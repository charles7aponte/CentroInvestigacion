...
<script >
    URL='{{URL::to('/')}}/formularioproyectos/eliminar/';
    fila_info="#dato_proyecto_";
</script>
   ...
   <div id="buscador-lista">
      <form class="navbar-form navbar-left" role="search">
        <div class="form-group">
          <input id="titulo_buscar" type="text" class="form-control" value="{{(isset($titulo) && $titulo)?$titulo:'' }}" placeholder="" >         <button id="bton_buscar_titulo" type="button" href="{{URL::to('/')}}/listadeproyectos/find/" 
        ...
        <table id="listaproyectos">
          ...
          @if(isset($campo_lista))
            @foreach ($campo_lista as $campo)
              <tr id="dato_proyecto_{{$campo['codigo_proyecto']}}">
                ...
                <td style="width:93px;">
                  <b onclick="eliminartipo({{$campo['codigo_proyecto']}})">
